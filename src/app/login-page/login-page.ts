...
import { FormsModule, NgForm } from '@angular/forms';1
...
export class LoginPage {
  constructor(private userservice: UserService, private router: Router) { }//inject the two services using constructor
